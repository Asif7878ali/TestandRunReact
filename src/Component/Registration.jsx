...
const Registration = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const register = "http://localhost:7000/register";
          ...
          <div className="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-100">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p className="text-sm font-light">
                ...
                <Link to="/">
                  <p className=" text-primary-600 hover:underline dark:text-primary-500 font-bold text-2xl cursor-pointer text-blue-600">
                    Login here
                  </p>
                </Link>
              </p>
